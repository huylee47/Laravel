<template>
    <section id="sidebar">
        <router-link to="/dashboard" class="brand">
            <img src="../assets/img/logo.png" alt="" style="width: 45px;"> DASHBOARD
        </router-link>
        <ul class="side-menu">
            <li><a href="#" class="active"><i class='bx bxs-dashboard icon'></i> Dashboard</a></li>
            
            <!-- Admin role check -->
            <li v-if="isAdmin" class="divider" data-text="Quản trị viên">Quản trị viên</li>
            <li v-if="isAdmin">
                <a href="#"><i class='bx bxs-inbox icon'></i> Quản trị <i class='bx bx-chevron-right icon-right'></i></a>
